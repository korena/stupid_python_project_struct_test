...
├── stupid_python_project_struct_test             # The main python package for the project
...
e.g: `cat stupid_python_project_struct_test/VERSION` will get the project version without harming
